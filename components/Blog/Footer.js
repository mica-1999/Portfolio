    ...
    <>
      ...
      <div className="row d-flex social-icons justify-content-center align-items-center">
        <div className="col-lg-12 d-flex justify-content-center align-items-center gap-4">
          <div className="social-icon-container d-flex justify-content-center align-items-center bg-white">
            <a href="https://www.linkedin.com/in/micael-ribeiro-a2230433a/" aria-label="LinkedIn Button" target="_blank" rel="noreferrer">
              <span uk-icon="icon: linkedin; width: 20; height: 20;">
          ...
          <div className="social-icon-container d-flex justify-content-center align-items-center bg-white">
            <a href="https://github.com/mica-1999" aria-label="GitHub Button" target="_blank" rel="noreferrer">
              <span uk-icon="icon: github; width: 20; height: 20;">
                <svg width="20" height="20" viewBox="0 0 20 20">
          ...
          <div className="social-icon-container d-flex justify-content-center align-items-center bg-white">
            <a href="https://x.com/ribeiro_micael" aria-label="Twitter Button" target="_blank" rel="noreferrer">
              <span uk-icon="icon: twitter; width: 20; height: 20;">
                <svg width="20" height="20" viewBox="0 0 20 20">
          ...
          <div className="social-icon-container d-flex justify-content-center align-items-center bg-white">
            <a href="https://www.instagram.com/goncalomicael20/" aria-label="Instagram Button" target="_blank" rel="noreferrer">
              <span uk-icon="icon: instagram; width: 20; height: 20;">
                <svg width="20" height="20" viewBox="0 0 20 20">
          ...
          <div className="social-icon-container d-flex justify-content-center align-items-center bg-white">
            <a href="#" aria-label="FaceBook Button" target="_blank" rel="noreferrer">
              <span uk-icon="icon: facebook; width: 20; height: 20;">
                <svg width="20" height="20" viewBox="0 0 20 20">
