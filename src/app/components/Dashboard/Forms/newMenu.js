            ...
            <form action="/dashboard/insertForm" method="POST">
              <div className="row">
                <div className="col-lg-6">
                    ...
                    <input type="text" className="form-control form-n1" id="name" name="name" required />
                </div>
                <div className="col-lg-6">
                    <label htmlFor="associateTo" className="form-label">Associate to</label>
                    <select className="form-select form-n1" id="associateTo" name="associateTo" aria-label="Associate to">
              ...
              <div className="row mb-2">
                <div className="col-lg-6">
                    ...
                    <select className="form-select form-n1" id="type" name="type" aria-label="Type">
