                                ...
                                <div className="modal-body">
                                    <div className="row">
                                        ...
                                        <div className="d-flex flex-column col-lg-12 align-items-center pb-2">
                                            <img src="/assets/images/dashboard/warning.png" alt="Warning icon" className="modalImage" />
                            ...
                            <>
                                <div className="modal-body">
                                    <div className="row">
                                        ...
                                        <div className="d-flex flex-column col-lg-12 align-items-center pb-2">
                                            <img src={showModal.type === 'success' ? '/assets/images/dashboard/success.png': '/assets/images/dashboard/error.png'} alt="Icon" className="modalImage" />
